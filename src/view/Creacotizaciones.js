...
class Creacotizaciones extends Component {
    
    constructor(props){
        super(props)
        this.messajin = 'Nada creado';
...
//                fetch('http://peaceful-retreat-91246.herokuapp.com/banwireapi/cotizacionesbynumero2/20200800007/NADA/NADA', requestInfo)
        ...
        this.messajin = 'buscarCotizacion paso 4';
...
if(medio_de_pago1!== null ){
arraymediodepago1 = { mediodepago: medio_de_pago1, comisionvariable: tazatarjeta_var, comisionvariabletipo: "PORCENTAJE", comisionfija: tazatarjeta_fija, comisionfijatipo: "MONTO", estatus: "ACTIVO" };
}
if(medio_de_pago2!== null ){
arraymediodepago2 = { mediodepago: medio_de_pago2, comisionvariable: tazaamex_var, comisionvariabletipo: "PORCENTAJE", comisionfija: tazaamex_fija, comisionfijatipo: "MONTO", estatus: "ACTIVO" };
}
if(medio_de_pago3!== null ){
arraymediodepago3 = { mediodepago: medio_de_pago3, comisionvariable: tazaoxxo_var, comisionvariabletipo: "PORCENTAJE", comisionfija: tazaoxxo_fija, comisionfijatipo: "MONTO", estatus: "ACTIVO" };
}
if(medio_de_pago4!== null ){
arraymediodepago4 = { mediodepago: medio_de_pago4, comisionvariable: tazapaycash_var, comisionvariabletipo: "PORCENTAJE", comisionfija: tazapaycash_fija, comisionfijatipo: "MONTO", estatus: "ACTIVO" };
}
if(medio_de_pago5!== null ){
arraymediodepago5 = { mediodepago: medio_de_pago5, comisionvariable: tazaspei_var, comisionvariabletipo: "PORCENTAJE", comisionfija: tazaspei_fija, comisionfijatipo: "MONTO", estatus: "ACTIVO" };
}
arraymediodepago6 = { mediodepago: "Store Pay", comisionvariable: tazastorepay_var, comisionvariabletipo: "PORCENTAJE", comisionfija: tazastorepay_fija, comisionfijatipo: "MONTO", estatus: "ACTIVO" };

/*    
var mytoday = new Date();
var dd = String(mytoday.getDate()).padStart(2, '0');
var mm = String(mytoday.getMonth() + 1).padStart(2, '0'); //January is 0!
...
//        fetch('http://peaceful-retreat-91246.herokuapp.com/banwireapi/cotizaciones', requestInfo)
        ...
        .then(response =>{
          console.log(response);
            console.log('carlos z crea paso 1' );
            if(response.ok){
                console.log('carlos z crea paso 2' );
                return response.json()
            }
...
//        });
      ...
      .then(data =>{
            console.log('carlos z crea paso 3' );
            
        })      
        .catch(e => {
            console.log('carlos z crea paso  4 err' );
                ...
                <div className="forma">
                    ...
                    <div className="forma">
                        ...
                        <div className="forma mar_t_10 mar_b_10">
                            <input type="button" className="cotizar" id='propuesta' value="PROPUESTA carlos " onClick={gettypicodeInfo}/>
...
// Exporting component
export default Creacotizaciones ;

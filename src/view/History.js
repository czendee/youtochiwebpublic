    ...
    if((cotizacion_id!== null) || (ejecutivo_p!== null)
      ...
      || (mes_p!== null)
       || (parlistamcc!== null)
          ...
          var laUrlmandar='https://sandbox.generric.com/quote-back/api/cotizacionesbynumero2/'+valeId+'/'+valeNamenegocio+'/'+valeEjecutivo+'/'+valeContacto+'/'+valeMontomes +'/NADA/NADA/'+valeListammc;

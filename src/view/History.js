    ...
    /////////////////////////////////////////////////////////////////////////////////////////////Hacerlo en onload
      ...
      console.log('carlos z paso 2.7:' +tcampoendf.value);
          ...
          if(tcampolistamcc.value === ""){
           ...
           console.log('carlos z paso 2.5:' +laUrlmandar);
          laUrlmandar='https://sandbox.generic.com/quote-back/genericapi/cotizacionesbynumero2/'+valeId+'/'+valeNamenegocio+'/'+valeEjecutivo+'/'+valeContacto+'/'+valeMontomes +'/'+tcampostartf.value+'/'+tcampoendf.value+'/'+valeListammc;
          console.log('carlos z paso 2.6:' +laUrlmandar);
